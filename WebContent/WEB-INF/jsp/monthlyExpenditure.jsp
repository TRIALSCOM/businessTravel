        ...
        function loadChart(){
                        ...
                        itemStyle: {
                            ...
                            emphasis: {
                                color: new echarts.graphic.LinearGradient(
                                    0, 0, 0, 1,
                                    [
                                        {offset: 0, color: '#f7bf80'},
                                        {offset: 0.7, color: '#f79c82'},
                                        {offset: 1, color: '#f6654e'}
                                    ]
                                )
                            }
                        },
            ...
            function bindData(){
                setTimeout(function(){
                    ...
                    $.get("goToCostDetailByMOYON?identy=月份&monthOrYear="+text+"").done(function (data) {
				...
				<div class="col-md-12 col-xs-12 col-lg-12  TSBoxPosition">
					<div class="fh5co-form animate-box TSBox">
									...
									<div class="panel-body">
										...
										<div class="form-group" style="margin-top: 15px">
											<div class="form-group col-md-7">
												<label for="txt_search_place">选择月份</label> <select
						...
						<div class = "row">
							...
							<div class="col-md-11 " style="height: 60px;"></div>
						</div>
					</div>
			   </div>
			</form>
